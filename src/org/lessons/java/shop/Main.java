...
public class Main {
	...
	public static void main(String[] args) {
		...
		Prodotto prodotto1 = new Prodotto ("Shampoo", "Sunsilk per capelli lisci", 2 );
...
//		System.out.println("Il prezzo del prodotto è " + prodotto1.prezzoIva());
		System.out.println(prodotto1.getNomeEsteso());
		System.out.println(prodotto1.getPrezzoIva());				
	}
